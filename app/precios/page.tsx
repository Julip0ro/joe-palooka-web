export default function PreciosPage() {
  return (
    <main className="min-h-screen pb-10 pt-10">
      ...
      <div className="flex flex-col md:flex-row gap-8 justify-center items-center md:items-stretch p-0">
        <div className="flex flex-col md:flex-row gap-8 justify-center items-center md:items-stretch p-4">
          ...
          <div className="relative max-w-[320px] w-full">
            ...
            <div className="relative bg-zinc-900 rounded-[2rem] p-6 pt-10 shadow-lg border border-zinc-700 flex flex-col justify-between overflow-hidden">
      ...
      {/* SECCIÓN: NOTAS LEGALES Y POLÍTICA DE RECUPERACIÓN */}
      ...
      {/* SECCIÓN: PLANES SECUNDARIOS (OTRAS OFERTAS) */}
      ...
      {/* SECCIÓN: CLASES INDIVIDUALES (PAGOS ÚNICOS) */}
      <div className="flex items-center justify-center gap-4 mt-16 mb-6">
        <div className="h-px w-16 bg-zinc-800"></div>
        <span className="text-[10px] tracking-[0.3em] text-zinc-500 uppercase">
          clases unicas
      ...
      <h2 className="text-white text-center text-2xl md:text-3xl font-bold uppercase mb-10">
        <span className="text-red-600">entrena</span> cuando quieras
      </h2>
